...
export default async function RemindersPage() {
  ...
  const [
    ...
    supabase.from("v_member_status").select("id, gym_id, full_name, phone, end_date, plan_name, subscription_id, days_until_expiry, reminder_5_sent_at, reminder_3_sent_at, reminder_1_sent_at, photo_url").eq("gym_id", gym.id).lte("days_until_expiry", 3).gt("days_until_expiry", 0).not("subscription_id", "is", null),
